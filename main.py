...
AUTH_USER = os.environ.get('AUTH_USERS', '6127347210').split(',')
...
photologo = 'https://i.ibb.co/0y0gpzFh/file-992.jpg' #https://envs.sh/GV0.jpg
...
BUTTONSCONTACT = InlineKeyboardMarkup([[InlineKeyboardButton(text="📞 Contact", url="https://t.me/taporibot_bot")]])
keyboard = InlineKeyboardMarkup(
    [
        [
            InlineKeyboardButton(text="🛠️ Help", url="https://t.me/+fK5x8NgiYKQ0ZThl"),
